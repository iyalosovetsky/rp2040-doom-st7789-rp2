...
cmake -DCMAKE_BUILD_TYPE=MinSizeRel -DPICO_BOARD=pico2 -DPICO_DOOM_USB=OFF  -DPICO_SDK_PATH=/mnt/projs/pico/pico-sdk -DPICO_EXTRAS_PATH=/mnt/projs/pico/pico-extras ..
